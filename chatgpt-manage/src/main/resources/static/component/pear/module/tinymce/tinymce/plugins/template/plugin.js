...
(function () {
    ...
    var open = function (editor, templateList) {
      ...
      var onChange = function (templates, updateDialog) {
        return function (api, change) {
          if (change.name === 'chatgpt') {
            var newTemplateTitle = com.chatgpt;
      ...
      var onSubmit = function (templates) {
        return function (api) {
          ...
          findTemplate(templates, com.chatgpt).each(function (t) {
            getTemplateContent(t).then(function (previewHtml) {
    ...
    function Plugin () {
      global.add('chatgpt', function (editor) {
        register$1(editor);
        register(editor);
        setup(editor);
      });
