...
//			level: "level",			  //层级
    ...
    DTree.prototype.selectSetting = function() {
        ...
        this.verifyText = this.options.verifyText;
        // 调取下拉树的特殊处理页面元素标识
    ...
    DTree.prototype.renderSelectDom = function() {
        ...
        var verifyText = _this.verifyText;
        // 设置自定义表单隐藏域
        var selectInputName = _this.selectInputName;
        var selectInput = [];
        for(var key in selectInputName) {
            selectInput.push('<input type="hidden" dtree-id="' + rootId + '" dtree-node="' + key + '" name="' + selectInputName[key] + '" lay-verify="' + verify + '" lay-reqText="' + verifyText + '" value="" readonly>');
        }
