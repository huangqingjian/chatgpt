package com.chatgpt.ai.request;
...
public class ChatCompletionRequest {
    ...
    public ChatCompletionRequest messages(List<ChatCompletionMessage> messages) {
        this.setMessages(messages);
        return this;
    }

    public ChatCompletionRequest max_tokens(Integer max_tokens) {
        this.setMax_tokens(max_tokens);
        return this;
    }
    ...
    public ChatCompletionRequest top_p(Double top_p) {
        this.setTop_p(top_p);
        return this;
    }

    public ChatCompletionRequest n(Integer n) {
        this.n(n);
        return this;
    }
    ...
    public ChatCompletionRequest stop(List<String> stop) {
        this.stop(stop);
        return this;
    }

    public ChatCompletionRequest presence_penalty(Double presence_penalty) {
        this.setPresence_penalty(presence_penalty);
        return this;
    }

    public ChatCompletionRequest frequency_penalty(Double frequency_penalty) {
        this.setFrequency_penalty(frequency_penalty);
        return this;
    }

    public ChatCompletionRequest logit_bias(Map<String, Integer> logit_bias) {
        this.setLogit_bias(logit_bias);
        return this;
    }

    public ChatCompletionRequest user(String user) {
        this.setUser(user);
        return this;
    }
